            ...
            <header className="fixed top-0 w-full z-50 bg-white/95 backdrop-blur-md border-b border-[#D3DCE6]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between gap-4">
                    ...
                    <div className="hidden lg:flex items-center gap-3 flex-shrink-0">
                        <a href="https://docs.github.com/en/copilot" target="_blank" rel="noopener noreferrer" className="btn-primary-bbva text-xs px-4 py-2 whitespace-nowrap">
                            Documentation
                        </a>
                    </div>
                </div>
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                        ...
                        >
                            ...
                            <div className="flex flex-wrap items-center justify-center gap-6 mb-16">
                                <motion.a
                                    href="#fundamentos"
                                    className="btn-primary-bbva text-sm px-10 py-4 flex items-center gap-3"
                                ...
                                <motion.a
                                    href="#configuracion"
                                    className="btn-secondary-bbva text-sm px-10 py-4 flex items-center gap-3"
                                    whileHover={{ scale: 1.05 }}
                                    whileTap={{ scale: 0.95 }}
                                >
                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                                ...
                                <div className="card p-6 bg-[#F4F8FB] border-2 border-[#D3DCE6]">
                                    ...
                                    <div className="bg-white rounded p-3 text-xs font-mono border border-[#D3DCE6]">
                                        ...
                                        <div className="text-[#5A6872]">---</div>
                                        <div className="text-[#5A6872]">Always use React Hooks and TypeScript</div>
                                    </div>
                                </div>
                            </div>
                        </div>
